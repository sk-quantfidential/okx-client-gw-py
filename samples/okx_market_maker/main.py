...
from samples.okx_market_maker.risk.risk_calculator import RiskCalculator
from samples.okx_market_maker.services.health_checker import HealthChecker
...
class MarketMaker:
    ...
    def _create_strategy(self, settings: MarketMakerSettings) -> BaseStrategy:
        ...
        """
        strategy_map = {
            "grid": SampleMMStrategy,
            "inventory_skew": InventorySkewStrategy,
            "volatility": VolatilityStrategy,
        }

        strategy_class = strategy_map.get(settings.strategy_type, SampleMMStrategy)
