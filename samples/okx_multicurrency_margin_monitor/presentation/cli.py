"""CLI entry point for margin monitor.
...
from samples.okx_multicurrency_margin_monitor.application.services.monitor_service import (
    MonitorService,
)
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="OKX Delta-Neutral Position Margin Monitor (Multi-Currency Gateway Version)",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # Run full report (credentials from environment)
  python -m samples.okx_multicurrency_margin_monitor.main
